...
Pending: 4.8(b) (running, `r4-q35-9b-inst2`), 4.9 and 4.11 (`r4-deltas` hard controls, `r4-soft` soft arms), 4.12 delta (`r4-longstate`), all on the isolated app `kev-round4`.
